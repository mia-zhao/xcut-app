...
Download [XCut.dmg](https://xcut.app/downloads/XCut-0.9.0-beta.dmg) (requires macOS 14.0+), double-click to open it, then drag XCut to your Applications folder. Launch XCut from Applications or Spotlight.
